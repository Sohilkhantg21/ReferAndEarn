...
if($text=="🎟️  Bot Info"){
  Message($from_id, "<b>this Bot Create By @Sohilscodes In Php Server \n\n subscribe On youtube youtube.com/@sohilscripter</b>");
}
  if($text=="🏧  Payout"){
